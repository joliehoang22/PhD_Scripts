...
cd $path
ml R
bsub -q premium -P acc_mscic1 -n 20 -W 144:00 -R rusage[mem=4000] -R span[hosts=1] -R himem -o %J.stdout -eo %J.stderr Rscript ${path}nestedCV_job_form3_with_residID_full.R
#Job <199223689> is submitted to queue <premium>.
...
# Save results
saveRDS(results, "/sc/arion/projects/mscic1/results/jolie/LBP/blood-brain/qc2/nestedcv_brain_full_blood_with_residID_results_20250818.rds")
saveRDS(failed_genes, "/sc/arion/projects/mscic1/results/jolie/LBP/blood-brain/qc2/nestedcv_brain_full_blood_with_residID_failed_genes_20250818.rds")
...
write.csv(performance_df, "/sc/arion/projects/mscic1/results/jolie/LBP/blood-brain/qc2/nestedcv_brain_full_blood_with_residID_prediction_performance.csv", row.names = FALSE)
