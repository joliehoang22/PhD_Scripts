#code derived from form3_no_residID_base.R
library(data.table)
library(ggplot2)
library(readxl)
library(biomaRt)
...
write.table(results, file = "/sc/arion/projects/mscic1/results/jolie/LBP/blood-brain/qc2/top_brain_base_genes_elastic_net_blood_form3_no_indivdualID_nestedCV_multiple_job.txt", 
