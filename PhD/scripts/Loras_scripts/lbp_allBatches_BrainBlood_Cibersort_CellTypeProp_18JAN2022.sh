...
singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/data/input_LM22/:/src/data -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/data/output/:/src/outdir fractions /src/CIBERSORTxFractions --username lora.liharska@icahn.mssm.edu --token f609e4fd5544b7021f061f9d4c54ce79 --refsample /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/data/input_LM22/LM22-ref-sample.txt --phenoclasses /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/data/input_LM22/LM22-classes.txt --mixture /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/data/lbp_allBatches_RAPiD_featureCounts_TPM_AllGenesWithGeneSymbol_forCibersort_BLOODandBRAIN_776samples_NoBLOOD582_NoBRAIN734_NoBRAIN722_20JAN2022.RDS --QN TRUE --perm 100



singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/:/src/data -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/output/:/src/outdir fractions /src/CIBERSORTxFractions --username lora.liharska@icahn.mssm.edu --token f609e4fd5544b7021f061f9d4c54ce79 --refsample /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/input_LM22/LM22-ref-sample.txt --phenoclasses /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/input_LM22/LM22-classes.txt --mixture /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/lbp_allBatches_RAPiD_featureCounts_TPM_AllGenesWithGeneSymbol_forCibersort_BLOODandBRAIN_776samples_NoBLOOD582_NoBRAIN734_NoBRAIN722_20JAN2022.RDS --QN TRUE --perm 100



singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/:/src/data -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/output/:/src/outdir /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/fractions --username lora.liharska@icahn.mssm.edu --token f609e4fd5544b7021f061f9d4c54ce79 --refsample /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/input_LM22/LM22-ref-sample.txt --phenoclasses /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/input_LM22/LM22-classes.txt --mixture /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/lbp_allBatches_RAPiD_featureCounts_TPM_AllGenesWithGeneSymbol_forCibersort_BLOODandBRAIN_776samples_NoBLOOD582_NoBRAIN734_NoBRAIN722_20JAN2022.RDS --QN TRUE --perm 100

echo $PATH

for x in F00001*;do mv $x  ${x/0000/000};done
for x in hydra*;do echo $x  ${x/hydra/arion};done



#alldata is being defined as the source data; cibersort creating local environment with specific structure, need to tell it where the elements are -- source folder created called src/data in which the data from all data will go; src is local evn so it doesn't exist
singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/:/src/data -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/output/:/src/outdir fractions /src/CIBERSORTxFractions --username lora.liharska@icahn.mssm.edu --token f609e4fd5544b7021f061f9d4c54ce79 --refsample /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/input_LM22/LM22-ref-sample.txt --phenoclasses /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/input_LM22/LM22-classes.txt --mixture /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/lbp_allBatches_RAPiD_featureCounts_TPM_AllGenesWithGeneSymbol_forCibersort_BLOODandBRAIN_776samples_NoBLOOD582_NoBRAIN734_NoBRAIN722_20JAN2022.RDS --QN TRUE --perm 100
