...
##############################################################################################
#Single Cell -- lake_output2
#input_lake AGAIN with different parameters

singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/:/src/data -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/output_lake2/:/src/outdir fractions /src/CIBERSORTxFractions --token f609e4fd5544b7021f061f9d4c54ce79 --username lora.liharska@icahn.mssm.edu --single_cell TRUE --refsample lake_singleCell_reference_01FEB2022.txt --mixture lbp_allBatches_RAPiD_featureCounts_TPM_All58884ENSEMBLGenes_NoDups_forCibersort_BRAINOnly_533samples_01FEB2022.txt --fraction 0.25 --perm 100 --G.min 50 --G.max 1300


##############################################################################################
#Single Cell -- lake_output3
#input_lake AGAIN with different parameters

singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/:/src/data -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/output_lake3/:/src/outdir fractions /src/CIBERSORTxFractions --token f609e4fd5544b7021f061f9d4c54ce79 --username lora.liharska@icahn.mssm.edu --single_cell TRUE --refsample lake_singleCell_reference_01FEB2022.txt --mixture lbp_allBatches_RAPiD_featureCounts_TPM_All58884ENSEMBLGenes_NoDups_forCibersort_BRAINOnly_533samples_01FEB2022.txt --fraction 0.1 --perm 100 --G.min 50 --G.max 1300

##############################################################################################
#Single Cell -- lake_output4
#input_lake AGAIN with different parameters

singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/:/src/data -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/output_lake4/:/src/outdir fractions /src/CIBERSORTxFractions --token f609e4fd5544b7021f061f9d4c54ce79 --username lora.liharska@icahn.mssm.edu --single_cell TRUE --refsample lake_singleCell_reference_01FEB2022.txt --mixture lbp_allBatches_RAPiD_featureCounts_TPM_All58884ENSEMBLGenes_NoDups_forCibersort_BRAINOnly_533samples_01FEB2022.txt --fraction 0.05 --perm 100 --G.min 50 --G.max 1300



#Single Cell -- lake_output5
#input_lake AGAIN with different parameters


singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/alldata/:/src/data -B /sc/arion/projects/psychgen/lbp/files/lbp_cibersortx/output_lake5/:/src/outdir fractions /src/CIBERSORTxFractions --token f609e4fd5544b7021f061f9d4c54ce79 --username lora.liharska@icahn.mssm.edu --single_cell TRUE --refsample lake_singleCell_reference_01FEB2022.txt --mixture lbp_allBatches_RAPiD_featureCounts_TPM_All58884ENSEMBLGenes_NoDups_forCibersort_BRAINOnly_533samples_01FEB2022.txt --fraction 0.75 --perm 100 --G.min 50 --G.max 1300


##############################################################################################
#NOAM's parameters
rm -rf outdir_${Name}_custom3
mkdir outdir_${Name}_custom3
singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/mscic1/results/Noam/cibersortx/input_${Name}/:/src/data -B /sc/arion/projects/mscic1/results/Noam/cibersortx/outdir_${Name}_custom3/:/src/outdir fractions /src/CIBERSORTxFractions --token a188582f532b84b3378c82c0cdc624a6 --username noam.beckmann@icahn.mssm.edu --single_cell TRUE --refsample lake_singleCell_reference_01FEB2022.txt --mixture inputBM10cpm.txt --fraction 0.25 --perm 100 --G.min 50 --G.max 1300


rm -rf outdir_${Name}_custom4
mkdir outdir_${Name}_custom4
singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/mscic1/results/Noam/cibersortx/input_${Name}/:/src/data -B /sc/arion/projects/mscic1/results/Noam/cibersortx/outdir_${Name}_custom4/:/src/outdir fractions /src/CIBERSORTxFractions --token a188582f532b84b3378c82c0cdc624a6 --username noam.beckmann@icahn.mssm.edu --single_cell TRUE --refsample lake_singleCell_reference_01FEB2022.txt --mixture inputBM10cpm.txt --fraction 0.1 --perm 100 --G.min 50 --G.max 1300

rm -rf outdir_${Name}_custom5
mkdir outdir_${Name}_custom5
singularity exec --env R_LIBS_USER="" --env R_LIBS="" -B /sc/arion/projects/mscic1/results/Noam/cibersortx/input_${Name}/:/src/data -B /sc/arion/projects/mscic1/results/Noam/cibersortx/outdir_${Name}_custom5/:/src/outdir fractions /src/CIBERSORTxFractions --token a188582f532b84b3378c82c0cdc624a6 --username noam.beckmann@icahn.mssm.edu --single_cell TRUE --refsample lake_singleCell_reference_01FEB2022.txt --mixture inputBM10cpm.txt --fraction 0.05 --perm 100 --G.min 50 --G.max 1300
# --------------------------------------------------------------------------------
...
setfacl -R -m u:beckmn:rwx myfolder
